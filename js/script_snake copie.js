...
window.onload = function() {
  ...
  var ctx;
  var delay = 100; // 100 = 1000 milliseconde -> 1sec -> MODIFIE LA VITESSE
  ...
  function Apple(position) {
    ...
    this.draw = function() {
      ...
      var x = this.position[0] * blockSize + radius; // je défini la position x comme pour un rectangle, et j'ajoute le rayon pour que la pomme soit centrée
